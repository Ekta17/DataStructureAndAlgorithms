...
/**
 * Given a binary array, find the length of largest subarray with equal number of 0 and 1
 *
 * <p>Variable of Zero sum array --> treat 0 as -1 when calculating prefix sum
...
public class SubarrayWithEqual0And1 {
  ...
  public int getLength(int[] arr) {
    ...
    for (int i = 0; i < arr.length; i++) {
      ...
      if (prefixSum
          == 0) { // consider all the elements from 0 to current index as this will have equal
                  // number of 0 and 1
